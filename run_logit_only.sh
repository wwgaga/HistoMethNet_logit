...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=logit_only_8type_cpu
...
srun --cpu-bind=none python main.py \
  ...
  --lr 2e-4 \
  --k 10 \
  --exp_code task_dna_subtyping_LOGIT_ONLY_NIH_and_Penn_Ken_8type_100pct_CPU \
  --weighted_sample \
  --bag_loss ce \
...
echo "Results stored at: ${RESULTS_DIR}/task_dna_subtyping_LOGIT_ONLY_NIH_and_Penn_Ken_8type_100pct_CPU_s1/"
