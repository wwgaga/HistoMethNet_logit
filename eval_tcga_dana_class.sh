...
python eval.py --k 10 --models_exp_code All_data_Dana_class_contrast_uni_2_feature_trans_classifer_no_feature_mlps_s1 --splits_dir splits/task_2_TCGA_Dana_100 --cell_property stem --save_exp_code tcga_uni2_feature_contrastive_transmlp_dana_classes --task task_3_cell_type_classification --model_type rrt --results_dir results --data_root_dir /cbica/home/tianyu/dataset/TCGA_selected_slides_features_extracted_UNI_2 --data_csv dataset_csv/matched_data_TCGA_Dana.csv --embed_dim 1536 
