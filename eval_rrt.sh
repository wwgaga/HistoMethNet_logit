...
python eval.py --k 10 --models_exp_code task_dna_subtyping_RRT_s1 --splits_dir splits/task_3_cell_type_classification_100 --save_exp_code task_dna_subtyping_RRT_s1_cv --task task_3_cell_type_classification --model_type rrt --results_dir results --data_root_dir /cbica/home/tianyu/dataset/Natalie_Cohort_UNI_Features --embed_dim 1024
